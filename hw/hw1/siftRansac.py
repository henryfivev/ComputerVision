...
class Stitcher:
    ...
    def Stitch(self, images, ratio=0.75, reprojThresh=4.0, method=1):
        ...
        M = self.matchKeypoints(
            kpsA, kpsB, featuresA, featuresB, ratio, reprojThresh, method=method
        )
    ...
    def matchKeypoints(
        self, kpsA, kpsB, featuresA, featuresB, ratio, reprojThresh, method
    ):  # method=1为BF暴力匹配， method=2为Flann匹配
        if method == 1:
            # 建立暴力匹配器
